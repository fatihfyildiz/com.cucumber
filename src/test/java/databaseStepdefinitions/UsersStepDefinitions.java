...
public class UsersStepDefinitions {
    ...
    public void isim_verilerini_test_eder() throws SQLException {
        ...
        // ilk ismi yazdiralim
        // resultSet iterator ile calisir ve gittigi yerde kaliyordu
        ...
        Assert.assertEquals(expectedSonIsim,actualSonIisim);

        // tum isim lsitesini yazdirin
        System.out.println("===================="); // once bir ayiralim ki belli olsun

        resultSet.absolute(0);
        // iteratoru'umuzu ilk veriye getirdik first() ile ama asagida next oldugu icin sonrakinden basliyor
        // dolayisiyla 0'nci satir'dan baslattik ki next() ile ilk veriyi ve soonrasindakiler getisin diye
        // tabi ki de bunun yaparken while ile yapmaliydik...
        // int siraNo= 1; ==> boyle sira no da verebiliriz

        while (resultSet.next()){
            System.out.println(resultSet.getString("first_name"));
            // System.out.println(siraNo+"-"+resultSet.getString("first_name")); ==> sira no verince sout da boyle olur
            // siraNo++;
        }
